...
keywordHandler:addKeyword({ "shop" }, StdModule.say, { npcHandler = npcHandler, text = "Nah, this is not a real shop. I have some offers, though. If you're interested, just ask me for a {trade}. There are other {merchants} on {Asha} as well." })
...
keywordHandler:addKeyword({ "asha" }, StdModule.say, { npcHandler = npcHandler, text = "This island will prepare you for the main continent of {Tibia}. Learn to fight and grow stronger!" })
...
keywordHandler:addKeyword({ "dungeon" }, StdModule.say, { npcHandler = npcHandler, text = "You'll find a lot of dungeons if you look around. One example are the {sewers} below Asha." })
