...
keywordHandler:addKeyword({ "information" }, StdModule.say, { npcHandler = npcHandler, text = "What kind of information do you need? I could tell you about different topics such as {equipment}, {monsters} or {Asha} in general." })
...
keywordHandler:addKeyword({ "asha" }, StdModule.say, { npcHandler = npcHandler, text = "Ah, Asha. Home sweet home, that's what it became for me, but I will always miss {Thais} and {Sam}." })
...
keywordHandler:addKeyword({ "sewer" }, StdModule.say, { npcHandler = npcHandler, text = "There are many sewer entrances throughout Asha. One is right outside this shop and to the left. For more details about monsters and dungeons, best talk to one of the {guards}." })
