...
keywordHandler:addKeyword({ "druid" }, StdModule.say, { npcHandler = npcHandler, text = "There are only two other druids on Asha, {Lily} and {Cipfried}." })
...
keywordHandler:addKeyword({ "asha" }, StdModule.say, { npcHandler = npcHandler, text = "I rarely visit the town. It's much better here." })
