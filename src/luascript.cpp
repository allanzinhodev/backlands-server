...
void LuaScriptInterface::registerFunctions()
{
	...
	registerGlobalVariable("SKILLTREE_SYSTEM_ENABLED", ConfigManager::SKILLTREE_SYSTEM_ENABLED);
	...
	registerEnumIn("configKeys", ConfigManager::SKILLTREE_SYSTEM_ENABLED);
